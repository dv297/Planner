-- CreateEnum
CREATE TYPE "IssueStatus" AS ENUM ('PLANNING', 'NOT_STARTED', 'IN_PROGRESS', 'READY_FOR_REVIEW', 'COMPLETE', 'CLOSED');
...
-- CreateIndex
CREATE UNIQUE INDEX "TeamUsers_id_key" ON "TeamUsers"("id");
...
-- AddForeignKey
ALTER TABLE "TeamUsers" ADD CONSTRAINT "TeamUsers_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
